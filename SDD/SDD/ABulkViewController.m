...
@interface ABulkViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    //控制电击的不限
    int num ;
...
@implementation ABulkViewController
...
//    [backBtn setTitle:@"新项目团购" forState:UIControlStateNormal];
//    
...
-(void)DetailsTapClick:(UITapGestureRecognizer *)tap
{
    ...
    RentShopsIndustryView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, viewWidth, 568)];
...
-(void)createTableView
{
    ...
    minRentShopsIndustryView = [[UIView alloc] initWithFrame:CGRectMake(0, viewHeight-480, viewWidth, 418)];
    minRentShopsIndustryView.backgroundColor = [UIColor whiteColor];
    [self.view addSubview:minRentShopsIndustryView];
...
-(NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    if (tableView == _DetProjectNatureTableView)
    {
        return _DetProjectNatureArray.count;
    }
    return 0;
}
