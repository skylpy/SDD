//
//  DirectNormalMoreViewController.m
//  SDD
//  更多品牌详情（普通直营）
...
#import "GroupRentViewController.h" //新项目招商
...
@interface DirectNormalMoreViewController ()
{
    /*- data -*/
...
@implementation DirectNormalMoreViewController
...
- (NSDictionary *)getBaseInfo{
    ...
    NSArray *investmentAnalysisContent =  @[
                                            model.referenceStore == nil?@"暂无":[NSString stringWithFormat:@"%@",model.referenceStore],
                                            model.businessArea == nil?@"暂无":[NSString stringWithFormat:@"%@m²",model.businessArea],
                                            model.floor == nil?@"暂无":[NSString stringWithFormat:@"%@层",model.floor],
                                            model.traffic == nil?@"暂无":[NSString stringWithFormat:@"%@人/天",model.traffic],
                                            model.totalInvestmentAmount == nil ?@"暂无":[NSString stringWithFormat:@"%@万元",model.totalInvestmentAmount],
                                            model.volume == nil? @"暂无":[NSString stringWithFormat:@"%@单/月",model.volume],
                                            model.averageConsumption == nil ?@"暂无":[NSString stringWithFormat:@"%@元/人",model.averageConsumption],
                                            model.revenue == nil?@"暂无":[NSString stringWithFormat:@"%@元/月",model.revenue],
                                            model.operatingCosts == nil?@"暂无":[NSString stringWithFormat:@"%@元/月",model.operatingCosts],
                                            model.depreciationShare == nil?@"暂无":[NSString stringWithFormat:@"%@元/月",model.depreciationShare],
                                            model.grossProfit == nil?@"暂无":[NSString stringWithFormat:@"%@%s",model.grossProfit,"%"],
                                            model.annualProfit == nil?@"暂无":[NSString stringWithFormat:@"%@万/年",model.annualProfit],
                                            model.paybackPeriod == nil?@"暂无":[NSString stringWithFormat:@"%@个月",model.paybackPeriod],
                                            model.responseRate == nil?@"暂无":[NSString stringWithFormat:@"%@%s",model.responseRate,"%"],
                                            ];
...
- (void)setupUI{
    ...
    preferentialDalail.text = [NSString stringWithFormat:@"%@",model.joinConditions];
    [contentView addSubview:preferentialDalail];
    [preferentialDalail mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(lineView2.mas_bottom).with.offset(13);
        make.left.equalTo(contentView.mas_left).with.offset(10);
