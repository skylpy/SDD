...
@interface NormalJoinViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    /*- data -*/
...
@implementation NormalJoinViewController
...
- (void)titleTap:(UIGestureRecognizer *)tap{
    ...
    switch (titleTag) {
        ...
        case 1000:
        {
            NormalJoinMoreViewController *preVC = [[NormalJoinMoreViewController alloc] init];
