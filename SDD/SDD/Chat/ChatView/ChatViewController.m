...
- (void)viewDidLoad
{
    ...
    if (_projectName) {
        ...
        [self sendTextMessage:[NSString stringWithFormat:@"您好！贵方的项目“%@”我已看过详细情况，对项目非常感兴趣，现希望能和贵方进行详细的接触了解。",_projectName]];
    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.row < [self.dataSource count]) {
        ...
        if ([obj isKindOfClass:[NSString class]]) {
            ...
            model.headImageURL = [NSURL URLWithString:@"http://img0.bdstatic.com/img/image/shouye/fengjing0923.jpg"];
