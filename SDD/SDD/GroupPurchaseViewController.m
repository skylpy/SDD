...
@interface GroupPurchaseViewController ()<UITableViewDataSource,UITableViewDelegate,DOPDropDownMenuDataSource,DOPDropDownMenuDelegate>{
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([model.hr_activityCategoryId integerValue] != 2 && type == 0) {
        ...
        grDetail.hr_activityCategoryId = model.hr_activityCategoryId;
        grDetail.type = 0;
        ...
        gpDetail.hr_activityCategoryId = model.hr_activityCategoryId;
        gpDetail.type = 2;
