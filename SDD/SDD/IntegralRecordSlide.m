...
#define TOPHEIGHT 40
@interface IntegralRecordSlide()<UIScrollViewDelegate>
{
    UIView * Btnview;
...
@implementation IntegralRecordSlide

@synthesize GainTableView,EmployTableView;
...
-(void) initSlideView{
    ...
    [_slideView setBackgroundColor:dblueColor];
...
-(void) initDownTables{
    ...
    GainTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT*2)style:UITableViewStyleGrouped];
    GainTableView.tag = 100;
    //GainTableView.separatorStyle = UITableViewCellSelectionStyleNone;
    //ProjectTableView.scrollEnabled =NO;
    
    //DeveloperTableView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"line"]];
    [_scrollTableViews addObject:GainTableView];
    [_scrollView addSubview:GainTableView];
    
    
    
    EmployTableView = [[UITableView alloc] initWithFrame:CGRectMake(1*_mViewFrame.size.width, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT)style:UITableViewStyleGrouped];
    EmployTableView.tag = 101;
    //EmployTableView.separatorStyle = UITableViewCellSelectionStyleNone;
    //BrandTableView.scrollEnabled =NO;
    
    //BrandsTableView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"line"]];
    [_scrollTableViews addObject:EmployTableView];
    [_scrollView addSubview:EmployTableView];
