...
@interface IspectVPhotoViewController ()<UIScrollViewDelegate>
{
...
@implementation IspectVPhotoViewController
...
- (void)setupUI {
    ...
    imageScrollView.contentOffset = CGPointMake(_index*viewWidth, 0);
}
