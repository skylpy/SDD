...
@interface JoinDatailBrandViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    /*- data -*/
...
@implementation JoinDatailBrandViewController
...
- (void)setupUI{
    ...
    _headImage.tag = 100;
//    
//    [_headImage setImageToBlur:_headImage.image
...
//    [_headImage addSubview:discoLabel];
//    [discoLabel mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.top.equalTo(_headImage.mas_top).with.offset(30);
//        make.centerX.equalTo(_headImage);
//    }];
//
//    
//    UILabel * coupons = [[UILabel alloc] init];
//    coupons.textColor = tagsColor;
//    coupons.font = [UIFont systemFontOfSize:20];
//    coupons.text = @"优惠券";
//    [_headImage addSubview:coupons];
//    [coupons mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.top.equalTo(discoLabel.mas_bottom).with.offset(0);
//        make.centerX.equalTo(_headImage);
//    }];
//    
//    UILabel * explain = [[UILabel alloc] init];
//    explain.textColor = lgrayColor;
//    explain.font = titleFont_15;
//    explain.text = [NSString stringWithFormat:@"%@ | %@人已领",
//                    model.fd_discountCoupons[@"maxPreferentialStr"],
//                    model.fd_discountCoupons[@"userGetQty"]];//@"最高减2万|1553人已领";
//    [_headImage addSubview:explain];
//    [explain mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.top.equalTo(coupons.mas_bottom).with.offset(0);
//        make.centerX.equalTo(_headImage);
//    }];
...
//    label_num.alpha = 0.7;
    ...
    [bgView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(view_zxlq.mas_bottom).with.offset(10);
        make.left.equalTo(contentView.mas_left).with.offset(0);
    ...
    switch (titleTag) {
        case 101:
        {
            if ([dictData[@"dynamicList"] count]>0) {
                ...
                // 最新动态
                BranksIntroductionViewController *biVC = [[BranksIntroductionViewController alloc] init];
                biVC.introductionContent = [NSString stringWithFormat:@"%@",dict_dy[@"description"]];
                biVC.NavTitle = @"最新动态";
                [self.navigationController pushViewController:biVC animated:YES];
            }
