...
#define TOPHEIGHT 40
@interface MyCerSlideView()<UIScrollViewDelegate>
{
    UIView * Btnview;
...
@implementation MyCerSlideView


@synthesize DeveloperTableView,BrandsTableView;
...
-(void) initDownTables{
    ...
    DeveloperTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT*2)];
    DeveloperTableView.tag = 100;
    DeveloperTableView.separatorStyle = UITableViewCellSelectionStyleNone;
    DeveloperTableView.scrollEnabled =NO;
    
    //DeveloperTableView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"line"]];
    [_scrollTableViews addObject:DeveloperTableView];
    [_scrollView addSubview:DeveloperTableView];
    
    
    
    BrandsTableView = [[UITableView alloc] initWithFrame:CGRectMake(1*_mViewFrame.size.width, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT)];
    BrandsTableView.tag = 101;
    BrandsTableView.separatorStyle = UITableViewCellSelectionStyleNone;
    BrandsTableView.scrollEnabled =NO;
    
    //BrandsTableView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"line"]];
    [_scrollTableViews addObject:BrandsTableView];
    [_scrollView addSubview:BrandsTableView];
