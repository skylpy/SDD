...
#define TOPHEIGHT 40
@interface MyIssueSlideView()<UIScrollViewDelegate>
{
    UIView * Btnview;
...
@implementation MyIssueSlideView

@synthesize ProjectTableView,BrandTableView;
...
-(void) initDownTables{
    ...
    ProjectTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT*2)style:UITableViewStyleGrouped];
    ProjectTableView.tag = 100;
    ProjectTableView.separatorStyle = UITableViewCellSelectionStyleNone;
    ...
    [_scrollTableViews addObject:ProjectTableView];
    [_scrollView addSubview:ProjectTableView];
    
    
    
    BrandTableView = [[UITableView alloc] initWithFrame:CGRectMake(1*_mViewFrame.size.width, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT)style:UITableViewStyleGrouped];
    BrandTableView.tag = 101;
    BrandTableView.separatorStyle = UITableViewCellSelectionStyleNone;
    //BrandTableView.scrollEnabled =NO;
    
    //BrandsTableView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"line"]];
    [_scrollTableViews addObject:BrandTableView];
    [_scrollView addSubview:BrandTableView];
