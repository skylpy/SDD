...
@interface NewReservationController ()<UITextFieldDelegate,FSDropDownMenuDataSource,FSDropDownMenuDelegate>{
...
@implementation NewReservationController
