//
//  NewReservationIndexViewController.m
//  SDD
//
...
@interface NewReservationIndexViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    UIView *shadowView;
    UIView *shadowView2;
...
@property (strong, nonatomic) ReserSlideView * reserSlideView;
...
@implementation NewReservationIndexViewController
...
-(void) initSlideWithCount: (NSInteger) count{
    ...
    _reserSlideView = [[ReserSlideView alloc] initWithFrame:screenBound WithCount:count];
