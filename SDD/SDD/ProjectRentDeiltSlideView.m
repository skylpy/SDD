...
#define TOPHEIGHT 40
@interface ProjectRentDeiltSlideView()<UIScrollViewDelegate>
{
    UIView * Btnview;
...
@implementation ProjectRentDeiltSlideView

@synthesize AppointmentTableView,ActivityTableView;
...
-(void) initDownTables{
    ...
    AppointmentTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT*2-20)];
    AppointmentTableView.tag = 100;
    AppointmentTableView.separatorStyle = UITableViewCellSelectionStyleNone;
    
    
    [_scrollTableViews addObject:AppointmentTableView];
    [_scrollView addSubview:AppointmentTableView];
    
    
    
    ActivityTableView = [[UITableView alloc] initWithFrame:CGRectMake(1*_mViewFrame.size.width, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT)];
    ActivityTableView.tag = 101;
    ActivityTableView.separatorStyle = UITableViewCellSelectionStyleNone;
    
    
    [_scrollTableViews addObject:ActivityTableView];
    [_scrollView addSubview:ActivityTableView];
