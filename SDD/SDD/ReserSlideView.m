...
#import "ReserSlideView.h"
#define TOPHEIGHT 40
@interface ReserSlideView()<UIScrollViewDelegate>
{
    UIView * Btnview;
...
-(void) initTopTabs{
    ...
    _topScrollView.backgroundColor =lgrayColor;
    ...
    for (int i = 0; i < array.count; i ++) {
        ...
        Btnview = [[UIView alloc] initWithFrame:CGRectMake(i * width, 0, width, TOPHEIGHT-1)];
        Btnview.tag = 100+i;
        Btnview.backgroundColor = [UIColor whiteColor];
        
        
        UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, width-0.5, TOPHEIGHT-1)];
        button.tag = i+10;
...
-(void) initDownTables{
    ...
    ProceedTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT*2-64)style:UITableViewStyleGrouped];
    ...
    CompleteTableView = [[UITableView alloc] initWithFrame:CGRectMake(1*_mViewFrame.size.width, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT*2-64)style:UITableViewStyleGrouped];
    ...
    FailureTableView = [[UITableView alloc] initWithFrame:CGRectMake(2*_mViewFrame.size.width, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT*2-64)style:UITableViewStyleGrouped];
...
-(void) updateTableWithPageNumber: (NSUInteger) pageNumber{
    ...
    CGRect tableNewFrame = CGRectMake(pageNumber * _mViewFrame.size.width, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT*2-64);
