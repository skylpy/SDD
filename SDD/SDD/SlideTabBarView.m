...
#pragma mark -- 记录滚动值
    ...
    NSInteger countTag;
//    UITableView * DuseTableView;
//    UITableView * useTableView;
//    UITableView * overdueTableView;
}
///@brife 整个视图的大小
...
@synthesize useTableView,DuseTableView,overdueTableView;
...
-(void) initSlideView{
    ...
    _slideView = [[UIView alloc] initWithFrame:CGRectMake(0, TOPHEIGHT - 5+3, width, 2)];
...
-(void) initScrollView{
    _scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, _mViewFrame.origin.y+34, _mViewFrame.size.width, _mViewFrame.size.height)];
...
-(void) initDownTables{
    ...
    DuseTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT)];
    DuseTableView.tag = 100;
    DuseTableView.separatorStyle = UITableViewCellSelectionStyleNone;

    
    DuseTableView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"line"]];
    [_scrollTableViews addObject:DuseTableView];
    [_scrollView addSubview:DuseTableView];
    
    
    
    useTableView = [[UITableView alloc] initWithFrame:CGRectMake(1*_mViewFrame.size.width, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT)];
    useTableView.tag = 101;
    useTableView.separatorStyle = UITableViewCellSelectionStyleNone;

    
    useTableView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"line"]];
    [_scrollTableViews addObject:useTableView];
    [_scrollView addSubview:useTableView];
    
    overdueTableView = [[UITableView alloc] initWithFrame:CGRectMake(2*_mViewFrame.size.width, 0, _mViewFrame.size.width, _mViewFrame.size.height - TOPHEIGHT)];
    overdueTableView.tag = 102;
    overdueTableView.separatorStyle = UITableViewCellSelectionStyleNone;
    
    overdueTableView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"line"]];
    [_scrollTableViews addObject:overdueTableView];
    [_scrollView addSubview:overdueTableView];
