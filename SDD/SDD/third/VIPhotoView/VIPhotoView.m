...
- (void)updateImageSize:(CGSize)size
{
    ...
    containerRect.size = CGSizeMake(viewWidth, size.width*viewHeight/viewWidth);
...
- (void)setMaxMinZoomScale
{
    ...
    self.maximumZoomScale = MAX(2.5, maxScale); // Should not less than 1
    self.minimumZoomScale = 1.0;
}

- (void)centerContent
{
    [self.movingDelegate moving:YES];
